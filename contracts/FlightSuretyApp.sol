...
contract FlightSuretyApp {
    ...
    uint8 private constant STATUS_CODE_LATE_AIRLINE = 20;  // when oracles report back with 20, trigger payment process
    ...
    */
                                ...
                                public
    {
        ...
        flightSuretyData = FlightSuretyData(dataContract); // define reference to the data contract - flightsuretydata
    }
    ...
    * important function that is triggered when the oracle comes back with a flight status
    */
...
// define reference to data contract
  contract FlightSuretyData {
    // TODO: Add interfaces from FlightSuretyData
